...
import { Image as ImageIcon, Loader2, Sparkles, Upload, ArrowRight, Copy, Check, Wand2, AlertTriangle, CreditCard } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div 
              ...
              className={`border-2 border-dashed rounded-3xl h-64 flex flex-col items-center justify-center cursor-pointer transition-all ${
                selectedImage ? 'border-indigo-500 bg-white dark:bg-slate-900' : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-slate-400 dark:hover:border-slate-600 shadow-xl'
              }`}
            >
              {selectedImage ? (
